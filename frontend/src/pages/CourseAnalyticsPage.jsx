      ...
      <section className='relative mx-auto max-w-6xl space-y-6'>
        ...
        {data && (
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            ...
            <Card className='col-span-1 border border-[rgba(139,92,246,0.3)] bg-[rgba(255,255,255,0.04)] text-[#E5E7EB] backdrop-blur-xl'>
              <CardHeader>
            ...
            {/* Top Learners List */}
            <Card className='col-span-1 lg:col-span-2 border border-[rgba(34,211,238,0.3)] bg-[rgba(255,255,255,0.04)] text-[#E5E7EB] backdrop-blur-xl'>
              <CardHeader>
